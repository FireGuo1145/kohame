...
import type { Organization, OrganizationMember, Repository } from "@/lib/forge-types"

function OrganizationPage({ name, onOpen, user }: { name: string; onOpen: (name: string) => void; user: { username: string } | null }) {
